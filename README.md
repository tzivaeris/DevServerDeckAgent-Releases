...
- `DevServerDeckAgent-macos-arm64.zip` (temporarily not published as of `2.1.2` - macOS arm64 builds are paused pending a code-signing fix; the last available arm64 build is attached to the `v2.0.6` release)
